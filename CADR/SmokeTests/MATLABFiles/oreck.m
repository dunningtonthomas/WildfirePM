...
%SMPS import
pathSMPS = 'C:\Users\Thomas\Documents\MATLAB\GitHub\SPUR\WildfirePM\WildfirePM\CADR\SmokeTests\data\Oreck\SMPS';
smpsData = importSMPS(pathSMPS);
smpsDataRaw = smpsData;


%APS import
pathAPS = 'C:\Users\Thomas\Documents\MATLAB\GitHub\SPUR\WildfirePM\WildfirePM\CADR\SmokeTests\data\Oreck\APS';
...
smpsScan3 = smpsData(:,55:end);

apsScan1 = apsData(:,1:27);
apsScan2 = apsData(:,28:54);
apsScan3 = apsData(:,55:end);

%Truncating the scans based on start/stop times
%Begin when nebulizer is turned off and go to the end
scan1Start = datetime(2022, 07, 26, 11, 33, 00);

scan2Start = datetime(2022, 07, 26, 13, 03, 00);

scan3Start = datetime(2022, 07, 26, 14, 38, 00);
